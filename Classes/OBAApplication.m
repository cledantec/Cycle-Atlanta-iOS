...
static NSString *const kOBADefaultRegionApiServerName = @"script.google.com/macros/s/AKfycbxpN47XZQGAoh-N5wQtBETp51tznG3JnOrWsAVNy0xGJOkD8ibS/exec";
...
- (void)refreshSettings {
    ...
    regionApiServerName = [NSString stringWithFormat:@"https://%@", regionApiServerName];

    OBADataSourceConfig *obaRegionDataSourceConfig = [[OBADataSourceConfig alloc] initWithURL:[NSURL URLWithString:regionApiServerName] args:nil];
