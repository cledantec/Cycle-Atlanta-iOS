...
- (IBAction)unwindToSavedNotesViewController:(UIStoryboardSegue *)segue {
    NSLog(@"Back to My notes");
}

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    // Make sure your segue name in storyboard is the same as this line
    if ([[segue identifier] isEqualToString:@"SavedNotesToNote"])
    {
...
- (void)viewDidLoad
{
    ...
    //[noteManager setManagedObjectContext: [[[UIApplication sharedApplication] delegate] managedObjectContext]];
